...
import com.runo.notes.di.AppModule.TasksLocalDataSource
import com.runo.notes.di.AppModule.TasksRemoteDataSource
...
class DefaultTaskRepository @Inject constructor(
    ...
    private fun cacheTask(task : Task) : Task {
        ...
        val cachedTask = Task(task.title, task.description,task.created,task.updated, task.isCompleted, task.entry_id)
